...
public class Fraccion {
    ...
    public void setNumeradorResultado(int numeradorResultado) {
        this.numeradorResultado = numeradorResultado;
    }
    ...
    public void setDenominadorResultado(int denominadorResultado) {
        this.denominadorResultado = denominadorResultado;
    }
